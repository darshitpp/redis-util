...
@Service
public class SnappyService implements Operations {

    private final RedisTemplate<String, User> redisTemplate;
    private final HashOperations<String, String, User> hashOperations;

    public SnappyService(LettuceConnectionFactory redisConnectionFactory) {
        this.redisTemplate = RedisSerializationBuilder.getSnappyRedisTemplate(redisConnectionFactory, User.class);
